...
export const i18n: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "hero.cta": "查看文档",
    "follow.title": "关注我们",
    "follow.sub": "第一时间获取 NekoClaw 最新动态",
    "follow.xiaohongshu": "小红书：",
    "follow.x": "X：",
    "follow.community.title": "加入社区",
    "follow.community.discord": "Discord",
    "follow.community.dingtalk": "钉钉群",
    "brandstory.title": "Why NekoClaw？",
    "brandstory.para1":
      "NekoClaw 结合了「Neko」（猫）与「Claw」（爪子），代表一位灵巧、可靠、随时待命的 AI 搭档。",
    "brandstory.para2":
      "我们希望它不是冰冷的工具，而是一只随时准备帮忙的温暖「小爪子」，成为你数字生活中默契又敏捷的伙伴。",
    "features.title": "核心能力",
    "features.channels.title": "全域触达",
    "features.channels.desc":
      "支持钉钉、飞书、QQ、Discord、iMessage 等频道，一个 NekoClaw 按需连接。",
    ...
    "features.skills.desc": "内置定时任务，自定义技能目录，NekoClaw 自动加载。",
    "testimonials.title": "社区怎么说",
    "testimonials.viewAll": "查看全部",
    "testimonials.1": "NekoClaw 就该这样：多频道一个入口，Python 好改好部署。",
    "testimonials.2": "定时和心跳很实用，Skills 自己加，数据都在本地。",
    "testimonials.3": "想完全掌控的团队用着很顺手。",
    "usecases.title": "你可以用 NekoClaw 做什么",
    "usecases.sub": "",
    ...
    "usecases.creative.1":
      "睡前向 NekoClaw 说明目标并设定自动执行，次日即可获得可用的雏形。",
    "usecases.creative.2":
      "从选题、找素材到确定方向，NekoClaw 可协助完成视频内容创作全流程。",
    ...
    "usecases.productivity.3":
      "记录饮食与身体反应，由 NekoClaw 定期分析并呈现规律。",
    "usecases.research.1":
    ...
    "quickstart.hintAfter": "，即可通过钉钉、飞书、QQ 等频道使用 NekoClaw。",
    ...
    "quickstart.desc.script":
      "无需手动配置 Python，一行命令自动完成安装。脚本会自动下载 uv（Python 包管理器）、创建虚拟环境、安装 NekoClaw 及其依赖（含 Node.js 和前端资源）。注意：部分网络环境或企业权限管控下可能无法使用。",
  ...
  en: {
    ...
    "follow.sub": "Follow us for the latest NekoClaw updates",
    ...
    "brandstory.title": "Why NekoClaw?",
    "brandstory.para1":
      'NekoClaw combines "Neko" and "Claw" to suggest a nimble, dependable AI companion that is always ready to help.',
    "brandstory.para2":
      'More than just a cold tool, NekoClaw is a warm "little paw" that stays close, reacts quickly, and helps you get things done.',
    ...
    "usecases.title": "What you can do with NekoClaw",
    "usecases.sub": "",
    ...
    "usecases.creative.1":
      "Describe your goal to NekoClaw and set it to run overnight; get a working draft by the next day.",
    "usecases.creative.2":
      "From topic selection and material gathering to direction setting, NekoClaw supports the full video content workflow.",
    "usecases.productivity.1":
    ...
    "usecases.productivity.3":
      "Log diet and symptoms; NekoClaw analyzes and surfaces patterns over time.",
    "usecases.research.1":
    ...
    "quickstart.hintBefore":
      "Install → init → start. Configure channels to use NekoClaw on DingTalk, Feishu, QQ, etc. See ",
    ...
    "quickstart.desc.script":
      "No Python setup required, one command installs everything. The script will automatically download uv (Python package manager), create a virtual environment, and install NekoClaw with all dependencies (including Node.js and frontend assets). Note: May not work in restricted network environments or corporate firewalls.",
    "quickstart.desc.docker":
    ...
    "quickstart.badgeBeta": "Beta",
    footer: "NekoClaw — Works for you, grows with you",
